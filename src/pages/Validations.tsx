...
export default function Validations() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Validations</h1>
      ...
      {data?.solutions?.length > 0 && (
        <div className="card bg-yellow-50 dark:bg-[#1f1a0a] border-2 border-yellow-200 dark:border-[var(--border-primary)]">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h3 className="font-bold text-lg text-yellow-900 dark:text-gray-100">Human Validation Required</h3>
          ...
          <div key={solution._id} className="card hover:shadow-xl transition-all">
            <div className="flex items-start justify-between">
              <div className="flex items-start space-x-4 flex-1">
                <div className="w-12 h-12 bg-yellow-100 dark:bg-[#2a210f] rounded-lg flex items-center justify-center flex-shrink-0 mt-1">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center flex-wrap gap-3 text-sm">
                    ...
                    <span className="px-2 py-1 bg-blue-100 dark:bg-[#1e1f23] text-blue-700 dark:text-gray-300 text-xs rounded">
                      {solution.aiModel}
                    </span>
      ...
      {data?.solutions?.length === 0 && (
        <div className="card text-center py-12">
          ...
          <h3 className="mt-4 text-lg font-medium text-gray-900 dark:text-gray-100">No pending validations</h3>
